 ...
 */
export declare function createVestingAccountInstructions(vestingProgramId: PublicKey, governingTokenMint: PublicKey, publicKey: PublicKey, lamports: number): [PublicKey, Keypair, TransactionInstruction[]];
