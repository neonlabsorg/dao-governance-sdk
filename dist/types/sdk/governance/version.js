...
export function getGovernanceProgramVersion(connection, programId, env) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (programMetadataInfo) {
                ...
                try {
                    const programData = yield getProgramDataAccount(connection, new PublicKey(programId));
        ...
        try {
            ...
            const getVersion = yield simulateTransaction(connection, transaction, 'recent');
