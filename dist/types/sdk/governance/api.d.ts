...
import { MemcmpFilter } from '../core';
import { Governance, GovernanceAccount, Proposal, Realm, RealmConfigAccount, TokenOwnerRecord, VoteRecord } from './models';
...
export declare function getGovernanceAccounts<A extends GovernanceAccount>(connection: Connection, programId: PublicKey, AClass: new (args: any) => A, filters?: MemcmpFilter[]): Promise<ProgramAccount<A>[]>;
