...
import { DepositGoverningTokensArgs, DepositGoverningTokensMultiArgs, getGovernanceSchema, getTokenOwnerRecordAddress, GOVERNANCE_PROGRAM_SEED } from '../models';
import { shortMeta } from '../../tools';
import { PROGRAM_VERSION_V1, SYSTEM_PROGRAM_ID } from '../../registry';
export function depositGoverningTokensInstruction(programId, programVersion, realmKey, governingTokenSource, governingTokenMint, governingTokenOwner, payerKey, amount, vestingProgramId, voterWeightRecord, maxVoterWeightRecord, vestingTokenPubkey, vestingPubkey) {
    let data;
    if (!vestingProgramId) {
