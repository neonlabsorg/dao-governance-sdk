...
exports.VESTING_RECORD_SCHEMA = exports.VOTE_PERCENTAGE_SCHEMA = exports.CreateVotePercentage = exports.governanceAccountParser = exports.getGovernanceSchemaForAccount = exports.getGovernanceSchema = exports.GOVERNANCE_SCHEMA = exports.GOVERNANCE_SCHEMA_V1 = exports.createInstructionData = exports.serializeInstructionToBase64 = void 0;
...
const serializeInstructionToBase64 = (instruction) => {
    ...
    return Buffer.from((0, borsh_1.serialize)(exports.GOVERNANCE_SCHEMA, data)).toString('base64');
};
...
function createGovernanceSchema(programVersion) {
    return new Map([
        [
            accounts_1.RealmConfigArgs,
            {
                ...
                fields: [
                    ...
                    ...(programVersion > registry_1.PROGRAM_VERSION_V1
        ...
        [
            instructions_1.DepositGoverningTokensArgs,
            {
                ...
                fields: [
                    ['instruction', 'u8'],
                    // V1 of the program used restrictive instruction deserialisation which didn't allow additional data
                    programVersion > registry_1.PROGRAM_VERSION_V1 ? ['amount', 'u64'] : undefined
                ].filter(Boolean)
            }
        ],
        [
            instructions_1.DepositGoverningTokensEntry,
            {
                kind: 'struct',
                fields: [
                    ['release_time', 'u64'],
        ...
        [
            instructions_1.DepositGoverningTokensMultiArgs,
            {
                kind: 'struct',
                fields: [
                    ['instruction', 'u8'],
                    ['entries', [instructions_1.DepositGoverningTokensEntry]]
                ]
            }
        ],
        [
        ...
        [
            instructions_1.CloseVestingAccountArgs,
            {
                kind: 'struct',
                fields: [['instruction', 'u8']]
            }
        ...
        [
            instructions_1.SetDelegateAmountConfigArgs,
            {
                kind: 'struct',
                fields: [
                    ['instruction', 'u8'],
        ...
        [
            instructions_1.SetTransferAmountConfigArgs,
            {
                kind: 'struct',
                fields: [
                    ['instruction', 'u8'],
        ...
        [
            instructions_1.CreateVoterWeightRecordVestingArgs,
            {
                kind: 'struct',
                fields: [['instruction', 'u8']]
            }
        ...
        [
            instructions_1.CreateVoterWeightRecordFixedArgs,
            {
                kind: 'struct',
                fields: [['instruction', 'u8']]
            }
        ...
        [
            accounts_1.Proposal,
            {
                ...
                fields: [
                    ...
                    ['voteThresholdPercentage', { kind: 'option', type: accounts_1.VoteThresholdPercentage }],
                    ...(programVersion === registry_1.PROGRAM_VERSION_V1 ? [] : [['reserved', [64]]]),
                    ['name', 'string'],
...
function governanceAccountParser(classType) {
    return (0, core_1.borshAccountParser)(classType, (accountType) => getGovernanceSchemaForAccount(accountType));
}
exports.governanceAccountParser = governanceAccountParser;
class CreateVotePercentage {
    constructor(args) {
        this.vote_percentage = args.vote_percentage;
    }
}
exports.CreateVotePercentage = CreateVotePercentage;
exports.VOTE_PERCENTAGE_SCHEMA = new Map([
    [
...
exports.VESTING_RECORD_SCHEMA = new Map([
    [
        accounts_1.VestingSchedule,
        {
            kind: 'struct',
            fields: [
                ['releaseTime', 'u64'],
    ...
    [
        accounts_1.VestingRecord,
        {
            ...
            fields: [
                ...
                ['token', 'pubkey'],
                ['realm', 'pubkey'],
                ['schedules', { kind: 'vector', type: accounts_1.VestingSchedule }]
            ]
        }
    ]
]);
