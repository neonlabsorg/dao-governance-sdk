...
import { AccountMetaData, ExecuteTransactionArgs, getGovernanceSchema, getNativeTreasuryAddress, getProposalTransactionAddress, GOVERNANCE_SCHEMA, InsertTransactionArgs, RemoveTransactionArgs, SignOffProposalArgs } from '../models';
import { PROGRAM_VERSION_V1, PROGRAM_VERSION_V2, SYSTEM_PROGRAM_ID } from '../../registry';
export function removeTransactionInstruction(programId, proposalKey, tokenOwnerRecordKey, governanceAuthorityKey, proposalTransactionKey, walletKey) {
...
export function insertTransactionInstruction(programId, programVersion, governanceKey, proposalKey, tokenOwnerRecordKey, governanceAuthorityKey, payerKey, transactionInstructions, index, optionIndex, holdUpTime) {
...
export function signOffProposalInstruction(programId, programVersion, realmKey, governanceKey, proposalKey, signatoryKey, signatoryRecordKey, proposalOwnerRecordKey) {
    ...
    if (programVersion === PROGRAM_VERSION_V1) {
        keys.push({ pubkey: signatoryRecordKey, isWritable: true, isSigner: false }, { pubkey: signatoryKey, isWritable: false, isSigner: true }, { pubkey: SYSVAR_CLOCK_PUBKEY, isSigner: false, isWritable: false });
    }
    else {
...
export function executeTransactionInstruction(programId, programVersion, governanceKey, proposalKey, transactionAddressKey, transactionInstructions) {
...
//# sourceMappingURL=proposal-transaction.js.map