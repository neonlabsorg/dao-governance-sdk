...
import { CloseVestingAccountArgs, GOVERNANCE_PROGRAM_SEED, GOVERNANCE_SCHEMA, WithdrawGoverningTokensArgs } from '../models';
import { shortMeta } from '../../tools';
export function withdrawGoverningTokensInstruction(params) {
...
export function closeVestingAccountInstruction(params) {
