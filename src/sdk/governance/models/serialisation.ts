...
export function governanceAccountParser(classType: GovernanceAccountClass) {
  return borshAccountParser(classType, (accountType: GovernanceAccountType) => getGovernanceSchemaForAccount(accountType));
}
...
export const VESTING_RECORD_SCHEMA = new Map<Function, any>([
  [
    VestingSchedule,
    {
      kind: 'struct',
