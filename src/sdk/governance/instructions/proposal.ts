...
export function realmConfigAccountsKeys(programId: PublicKey, realmKey: PublicKey, voterWeightRecord?: PublicKey, maxVoterWeightRecord?: PublicKey): AccountMeta[] {
...
export function proposalSignatoryInstruction(
  programId: PublicKey,
  programVersion: number,
...
export function votePercentageInstruction(
  programId: PublicKey,
  governingOwnerRecord: PublicKey,
...
export const cancelProposalInstruction = (
  programId: PublicKey,
  programVersion: number,
  realmKey: PublicKey,
  governanceKey: PublicKey,
